...
def testClustering(patients, numClusters, verbose = False, seed = 0, numTrials = 5):
    random.seed(seed)
    bestClustering = trykmeans(patients, numClusters, numTrials, verbose)
...
for k in (2,4,6):
    ...
    posFracs = testClustering(patients, k, False, 2, 10)
